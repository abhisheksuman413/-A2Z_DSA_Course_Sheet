...
void fun2(long long n , long long cnt ,long long fact,vector<long long>&abhi){
    if(fact>n){
        return;
    }
    else{
...
int main()
{
    vector<long long> bs = factorialNumbers(7);
	for (auto i : bs)
	{
		cout << i;
	}
...
/*
Question_05 :-  N to 1 without loop

Link :- https://www.codingninjas.com/studio/problems/factorial-numbers-not-greater-than-n_8365435?utm_source=striver&utm_medium=website&utm_campaign=a_zcoursetuf
